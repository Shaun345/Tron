...
void DAC5_Init(void)
{
    ...
    IOMUX->SECCFG.PINCM[PB0INDEX] = 0x081;
    IOMUX->SECCFG.PINCM[PB1INDEX] = 0x081;
    IOMUX->SECCFG.PINCM[PB2INDEX] = 0x081;
    IOMUX->SECCFG.PINCM[PB3INDEX] = 0x081;
    IOMUX->SECCFG.PINCM[PB4INDEX] = 0x081;
    GPIOB->DOE31_0 |= 0x01F;
}

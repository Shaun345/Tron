...
// I/O port addresses
   ...
   .equ IOMUXPB4,       0x40428004+4*16
   .equ IOMUXPB5,       0x40428004+4*17
   .equ IOMUXPB6,       0x40428004+4*22
   .equ IOMUXPB7,       0x40428004+4*23
       .global main
       .global SysTick_Init
       .global SysTick_Wait
       .global SysTick_10ms
...
Traffic_Init:
   ...
   MOVS R0,#10
   BL   Clock_Delay   // stabilize, delay=3*R0 cycles
   LDR  R1,=0x00050081
   LDR  R0,=IOMUXPB7
